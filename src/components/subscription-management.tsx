                  ...
                  dangerouslySetInnerHTML={{
                    __html: `
                      <button
                        ...
                        onclick="localStorage.setItem('appilix_product_id', '${subscription?.interval === "year" ? "com.unishare.app.scholarplusoneyear" : "com.unishare.app.scholarplusonemonth"}'); appilixPurchaseProduct('${subscription?.interval === "year" ? "com.unishare.app.scholarplusoneyear" : "com.unishare.app.scholarplusonemonth"}', 'consumable', window.location.origin + '/dashboard/success')"
                      >
                        ${renewLoading ? `
