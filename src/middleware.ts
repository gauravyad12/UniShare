  ...
  try {
    ...
    if (response) {
      ...
      response.headers.set(
        ...
        "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://js.stripe.com https://appilix.com https://va.vercel-scripts.com https://*.vercel-insights.com https://*.vercel-analytics.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; img-src 'self' data: blob: https://*.supabase.co https://ncvinrzllkqlypnyluco.supabase.co https://screenshotmachine.com https://*.wikimedia.org https://*.wikipedia.org https://*.unsplash.com https://*.cloudinary.com https://*.githubusercontent.com https://*.googleusercontent.com https://*.ggpht.com https://*.ytimg.com https://*.twimg.com https://*.pexels.com https://*.pixabay.com https://*.imgur.com https://*.giphy.com https://*.dicebear.com https://covers.openlibrary.org http://covers.openlibrary.org https://books.google.com http://books.google.com https://books.googleusercontent.com http://books.googleusercontent.com https://archive.org http://archive.org https://*.archive.org http://*.archive.org https://*.yandex.ru https://*.yandex.com https://*.yadi.sk https://*.disk.yandex.ru https://*.downloader.disk.yandex.ru https://*.storage.yandex.net https://*.s3.yandex.net https://*.s3.mds.yandex.net https://*.s3.mdst.yandex.net https://*.vla.storage.yandex.net https://*.storage.yandex.com; font-src 'self' data:; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://appilix.com https://va.vercel-scripts.com https://*.vercel-insights.com https://*.vercel-analytics.com https://www.googleapis.com https://googleapis.com https://covers.openlibrary.org http://covers.openlibrary.org https://archive.org http://archive.org https://*.archive.org http://*.archive.org https://cloud-api.yandex.net https://*.yandex.ru https://*.yandex.com https://*.yadi.sk; frame-src 'self' https://js.stripe.com https://*.supabase.co https://ncvinrzllkqlypnyluco.supabase.co https://yadi.sk https://*.yadi.sk https://*.yandex.ru https://*.yandex.com https://*.litsolutions.org https://*.litsolutions.net https://*.litsolutions.info; object-src 'self' https://*.supabase.co https://ncvinrzllkqlypnyluco.supabase.co; media-src 'self' https://*.supabase.co https://ncvinrzllkqlypnyluco.supabase.co;"
      );
...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|og-assets|public|api/payments/webhook|api/proxy|api/debug|api/restart|api/healthcheck|opengraph-image|sitemap.xml|robots.txt).*)",
  ],
};
